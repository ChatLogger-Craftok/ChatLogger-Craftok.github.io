...
categories = {
    ...
    "Craftok": {
        ...
        "include_filters": [
            ...
            "téléportation de : ","vous avez été réduit au silence pour","vous pourrez à nouveau parler dans", "-----> craftok <-----",
            "les ms indiquent le temps de réponse avec le serveur", "latence avec le serveur", "les tps indiquent si le serveur est surchargé, 20 = parfait",
            "moyenne des tps (1min, 5min, 15min) :", "le mspt indique le temps de traitement, en dessous de 50 = parfait", "moyenne du mspt (1min) :", "serveur :"
        ],
        "exclusive": True
    },
    "AntiCheat": {
        ...
        "exclude_filters": [
            ...
            "-----> CRAFTOK <-----", "vient de vous inviter dans sa partie", "la demande de partie de", "vous avez rejoint la partie de", "ce joueur est déjà dans une partie",
            "chef :", "membres", "vous devez être le chef de votre partie", "vous n'êtes dorénavant plus amis avec"
        ],
        "include_filters": [
